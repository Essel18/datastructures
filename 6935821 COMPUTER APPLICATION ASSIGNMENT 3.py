#6935821
#DZORKA ELEKPLEM ESSEL
#COMPUTER APPLICATION ASSIGNMENT
#https://github.com/Essel18/datastructures.git
...
Car =["Toyota Corolla","Toyota Yaris","Toyota Camry","Toyota Rav4","Toyota Highlander","Toyota Fortuner","Toyota Sienna","Toyota Land Cruiser Prado",
      "Toyota Hilux","Toyota Tundra","Toyota Sequoia","Toyota Tacoma","Toyota Matrix","Nissan Pathfinder",
      ...
      "Mercedes-Benz C-Class","Audi A4","Audi A3","Audi R8"]
Models=["2001","2004","2005","2009","2010","2015","2020"]
Price=[30000,50000,150000,170000,300000,3400000,4000000]
CarModelPrice=[]
print("Welcome to Cars_hub Dealership")
...
if order in Car:
   ...
   if model in Models:
     ...
     print("Oops this model is not available")
else:
 print(" Oops this vehicle is not available")
